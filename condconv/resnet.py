"""A slightly modified resnet w/ configurable inplanes"""
...
class ConfigurableResNet(ResNet):
    ...
    def __init__(self, block: Type[Union[BasicBlock, Bottleneck]], layers: List[int], num_classes: int = 1000,
                 ...
                 in_planes: int = 64  # TODO - this is the only modification, in TV resnet it's hardcoded
...
def _resnet(
    ...
    **kwargs: Any
    ...
    model = ConfigurableResNet(block, layers, **kwargs)
    if pretrained:
